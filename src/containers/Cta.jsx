        ...
        <div className="flex max-tablet:flex-col items-center gap-12">
          ...
          >
            ...
            <p className="text-neutral-600 text-500 leading-relaxed">
              As the world of digital arts and fungible tokens evolves, it
              provides you with the opportunity to create, sell and profit from
              your unique work of arts and hardwork.
            </p>
